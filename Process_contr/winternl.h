...
//Delete by ChongyangLee,
//add RTL_HEAP_PARAMETERS and PRTL_HEAP_COMMIT_ROUTINE
...
//Edited by ChongyangLee
extern _CRTIMP LPSTR __cdecl _strlwr(LPSTR str); /* FIXME: Doesn't belong here */
extern _CRTIMP LPSTR __cdecl _strupr(LPSTR str); /* FIXME: Doesn't belong here */
...
HANDLE    WINAPI RtlCreateHeap(ULONG,PVOID,SIZE_T,SIZE_T,PVOID,PRTL_HEAP_PARAMETERS);
